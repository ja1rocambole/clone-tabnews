...
describe("PATCH /api/v1/activations/[token_id]", () => {
  describe("Anounymous user", () => {
    test("With noneexistent token", async () => {
      const response = await fetch(
        "http://localhost:3000/api/v1/activations/da6951ac-05a3-4430-8594-db0374f6934f",
        {
          method: "PATCH",
        },
      );
      ...
      expect(responseBody).toEqual({
        name: "NotFoundError",
        message: "O token de ativação utilizado não foi encontrado.",
